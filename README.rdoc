...
* Memory footprint(rss) shows how much memory the benchmark used with GC disabled.
  ...
  the actual memory consumption might be much lower than the numbers below.
    ...
    sequel #create  0.860000  7.200000  8.060000  11.19170  463.03m
    sequel #select  0.040000  0.820000  0.860000  0.910012  64.81m
    sequel #update  0.840000  6.700000  7.540000  10.29353  454.04m
