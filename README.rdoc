...
implementations. That said obviously if Swift were slower it would be redundant so benchmark code does exist in the
Swift ORM repository.

http://github.com/shanna/swift-orm/tree/master/benchmarks
