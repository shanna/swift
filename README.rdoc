...
means currently you cannot execute the following SQL using Swift currently,
...
and you are just limited to files, you can stream data from anywhere into MySQL directly
without creating temporary files pretty fast. 
